...
public class CustomerController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<CustomerDTO> getCustomerByName(@PathVariable("id") Long id) {

        return new ResponseEntity<CustomerDTO> (customerService.getCustomerById(Long.valueOf(id)), HttpStatus.OK);
    }

    @GetMapping("/{firstname}/{lastname}")
    public ResponseEntity<CustomerDTO> getCustomerByFirstAndLastName(@PathVariable("firstname") String firstname, @PathVariable("lastname") String lastname) {

        return new ResponseEntity<CustomerDTO> (customerService.getCustomerByFirstnameAndLastname(firstname, lastname), HttpStatus.OK);
